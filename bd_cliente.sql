...
CREATE TABLE `cliente` (
  ...
  `cliente_paterno` varchar(45) DEFAULT NULL,
  `cliente_materno` varchar(45) DEFAULT NULL,
  `cliente_nombre` varchar(45) DEFAULT NULL,
  `cliente_dni` varchar(45) DEFAULT NULL,
...
INSERT INTO `cliente` VALUES (1,'Beltran','Lopez','David','152635689','Trujillo','Santa Maria','956845215','dfgh@hotmail.com');
...
-- Dump completed on 2016-07-01 18:20:58
